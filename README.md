...
- **Custom Commands**: Use a set of custom commands designed to simplify your development workflow.
- **Python Scripting**: Create and run your own custom commands using Python scripts.
- **Cross-Platform Support**: Currently targeting Windows, with plans to support other operating systems in the future.
- **Simple and Lightweight**: Focused on providing a fast and clean terminal experience.
...
* **User-friendly configuration options**: Making it easier for users to customize ZMC behavior and appearance.
